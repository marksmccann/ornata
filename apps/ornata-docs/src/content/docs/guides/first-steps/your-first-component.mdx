...
<Aside type="note">
    Even without JavaScript, the HTML can still provide meaningful content from
    the start. How much it provides depends on you, the constraints of your
    environment, and the kind of component you are building.
</Aside>
...
If you want a fuller walkthrough of Ornata's explicit typing patterns and TypeScript helpers, read [TypeScript](/ornata/guides/typescript/).
