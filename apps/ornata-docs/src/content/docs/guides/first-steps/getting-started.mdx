...
<Aside type="tip">
    Pin a specific version in production so your deployed HTML always gets the
    same runtime.
</Aside>
...
<Aside type="note">
    Ornata treats markup as the integration surface. As the component author,
    you decide what your component expects from that markup and how flexible
...
- Read [Mounting Instances](/ornata/guides/mounting-instances/) to compare `mount()` and `mountAll()`
