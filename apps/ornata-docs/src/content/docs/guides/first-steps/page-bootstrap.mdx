...
description: Mount components declaratively from HTML with `mountAll` and a small page-level registry.
---
...
Use `mountAll()` when the page's HTML should declare which components get enhanced.
