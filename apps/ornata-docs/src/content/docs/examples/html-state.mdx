---
title: HTML State
description: Initialize component state from server-rendered HTML data attributes, then override or react to it in JavaScript.
---
import { Tabs, TabItem } from "@astrojs/starlight/components";

# HTML State

This example shows one of Ornata’s most useful server-rendered patterns: letting HTML provide the initial state.
